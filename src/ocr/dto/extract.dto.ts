...
export class ExtractResponseDto {
    ...
    @ApiProperty({
        oneOf: [
            ...
            { $ref: '#/components/schemas/ReceiptSchema' },
...
export class SupportedFormatsResponseDto {
    ...
    @ApiProperty({
        type: 'object',
        properties: {
            invoice: { $ref: '#/components/schemas/InvoiceSchema' },
            receipt: { $ref: '#/components/schemas/ReceiptSchema' },
            form: { $ref: '#/components/schemas/FormSchema' },
            table: { $ref: '#/components/schemas/TableSchema' },
        },
    })
    exampleSchemas: {
